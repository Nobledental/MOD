...
const organLibrary = {
  ...
  musculoskeletal: {
    ...
    model: getOrganModel('musculoskeletal'),
  },
  gi: {
  ...
  reproductive: {
    ...
    model: getOrganModel('reproductive'),
  },
  skin: {
